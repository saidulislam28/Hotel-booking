...
const Room = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      key: "max_person",
      render: (max_person: number) => <>{max_person}</>,
    },
    {
      title: "Floor",
      dataIndex: "floor",
      key: "floor",
      render: (floor: number) => <>{floor}th</>,
    },
    {
      title: "Room Size",
      dataIndex: "room_size",
      key: "room_size",
      render: (room_size: number) => <>{room_size}sqft</>,
    },
    {
      title: "Bed",
      dataIndex: "bed_count",
      key: "bed_count",
      render: (bed_count: number) => <>{bed_count}</>,
    },
    {
      title: "Is Active",
      dataIndex: "is_active",
