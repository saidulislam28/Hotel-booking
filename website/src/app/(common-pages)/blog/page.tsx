  ...
  return (
    <>
      ...
      <PageTitle
        ...
        title={title}
      />
      <div className="max-w-7xl mx-auto p-5 flex flex-col-reverse md:flex-row items-start gap-5">
        <div className="w-full md:w-[70%] grid grid-cols-1 md:grid-cols-2 gap-5">
