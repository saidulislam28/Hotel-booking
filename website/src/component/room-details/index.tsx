...
const RoomCardDetails = ({ id }: { id: string }) => {
                ...
                <div className="flex flex-col md:flex-row items-start gap-8">
                    <div className="w-full md:w-[70%]">
                        ...
                        <div className="space-y-5 mt-5 flex flex-col">
                            <div className="grid grid-cols-2 md:flex md:items-center md:justify-between border md:border-hidden border-gray-200 rounded-xl gap-4 p-4">
                                <h4 className="flex flex-col md:flex-row items-center gap-2">
                            ...
                            <div className="border-2 rounded-xl border-gray-200 p-5">
                                ...
                                <div className="mt-10">
                                    ...
                                    <div className="mt-12 bg-[#F2F4F4] p-5 space-y-3 rounded-xl">
                                        ...
                                        <p className="secondary_text">21 june, 2026</p>
                                        <p className="secondary_text">
                                            Their service was too good
                                        </p>
                    ...
                    <div className="w-full md:w-[30%]">
                        <RoomBookingTabs id={id} item={details} />
                    </div>
                </div>
            </div>
        </div>
